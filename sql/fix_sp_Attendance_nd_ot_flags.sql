-- Update sp_Attendance to check AllowNightDifferential and AllowOvertime flags from WorkSchedules
-- This script uses CREATE OR ALTER to replace the entire SP
